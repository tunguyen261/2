<%-- 
    Document   : shop
    Created on : Feb 22, 2022, 9:45:01 PM
                    ...
                    <div class="col-md-12">
                        <div class="product-filters">
                            <ul>
                                ...
                                <li data-filter=".strawberry">Fruit</li>
                                <li data-filter=".berry">Vegatable</li>
                            </ul>
                        </div>
                    </div>
                </div>-->
                    ...
                    <div class="row product-lists">
                        ...
                        <div class="col-lg-4 col-md-6 text-center strawberry">
                            <div class="single-product-item">
                                ...
                                <a class="cart-btn" href="MainController?action=AddCart&productID=<%=product.getProductID()%>&productName=<%=product.getProductName()%>&image=<%=product.getImage()%>&price=<%=product.getPrice()%>&quantity=1">Add to cart</a>
                            </div>
                        </div>
                        <%
                            }
